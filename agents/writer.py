...
def write_blog_post(topic: str, outline: str, style: str) -> str:
    ...
    - AUTOMATICALLY insert commands like `/infographics` or `/charts` on separate lines wherever key data, architecture, comparisons, or steps are discussed to indicate visual placements.
